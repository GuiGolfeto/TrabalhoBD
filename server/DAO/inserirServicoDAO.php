...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['cliente'], $_POST['profissional'], $_POST['dataServico'], $_POST['valorTotal'], $_POST['valorMaoObra'], $_POST['status'])) {
        ...
        $servicosObj->inserirServico($idCliente, $idProfissional, $dataServico, $valorTotal, $valorMaoObra, $idStatus);
    } else {
